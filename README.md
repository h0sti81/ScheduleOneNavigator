...
- **v0.1** - Initial release: minimap, full map overlay with Deals/Shops/Businesses/Dealers/Properties tabs, custom pathfinding, and auto-routing.

See the [releases page](https://github.com/h0sti81/ScheduleOneNavigator/releases) for full details on each version.
